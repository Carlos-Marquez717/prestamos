...
<br>
    <div class="container mx-auto px-4">
        <div class="max-w-md mx-auto bg-white p-4 rounded-lg shadow-md">
            <h1 class="text-xl font-bold mb-4 text-center">Agregar Cliente</h1>
            ...
            <form action="{{ route('clientes.store') }}" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        <label for="nombre" class="block text-sm font-medium text-gray-700 text-center">Nombre</label>
                    ...
                    <div>
                        <label for="telefono" class="block text-sm font-medium text-gray-700 text-center">Teléfono</label>
                    ...
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700 text-center">Correo Electrónico</label>
                    ...
                    <div>
                        <label for="direccion" class="block text-sm font-medium text-gray-700 text-center">Dirección</label>
                ...
                <div>
                    <button type="submit" class="w-full bg-indigo-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Agregar Cliente</button>
                </div>
            </form>
        </div>
    </div>
