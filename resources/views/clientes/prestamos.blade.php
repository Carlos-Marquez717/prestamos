...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="bg-black rounded-lg shadow-md px-6 py-4">
            ...
            <form action="{{ route('clientes.prestamos', $cliente) }}" method="GET">
                <div class="flex flex-wrap items-center justify-between mb-4">
                    ...
                    <div class="w-full md:w-auto mb-2 md:mb-0">
                        ...
                        <input type="text" name="nombre" id="nombre" class="px-4 py-2 w-full bg-gray-800 text-white border border-gray-600 rounded-md">
                    </div>
                    <div class="w-full md:w-auto mb-2 md:mb-0">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        @foreach ($prestamos as $prestamo)
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b border-gray-600 text-center">
                                    <a href="{{ route('prestamos.pdf', $prestamo) }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Descargar Boleta</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
